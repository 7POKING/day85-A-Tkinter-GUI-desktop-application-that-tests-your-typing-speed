...
textlist=[]
num_in_text2 =num_in_text = total_correct = best_score = total_correct_cpm =correct_char = position_in_text=position_in_sentence = int(0)
original_time_left = time_left = 60 
...
test_font = font.Font(font=('Arial', 24)) 
...
#restart button
from main import time_left_restart 
...
#Place the average allocation field in the window.
...
#Scrolling and line breaks in the display window------------------------------------------------------------------------------------------------------------------------------------------
